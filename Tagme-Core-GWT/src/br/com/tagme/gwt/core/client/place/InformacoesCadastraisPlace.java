...
public class InformacoesCadastraisPlace extends AuthBreadcumbPlace{
	
	public static final String PREFIX = "infcad";
	
	public InformacoesCadastraisPlace(String token){
		
		super(PREFIX, token, "Dados Cadastrais");
	...
	public static class Initializer extends ChangeHistoryTokenizer implements IActivityFactory{
		...
		public Place getPlace(String token) {
			return new InformacoesCadastraisPlace(token);
		}
		
		@Override
		public DefaultActivity createActivity(AbstractPlace targetPlace) {
			if(targetPlace instanceof InformacoesCadastraisPlace){
